...
Adodc1.Refresh
If txtGName.Text = "" Or txtCName.Text = "" Or txtAddress.Text = "" Or txtContact.Text = "" Or txtEmail.Text = "" Or txtPrice.Text = "" Or QTY.Text = "" Then
...
Rs.Fields("Price").value = Format(Val(txtPrice.Text), "00.00")
...
MType.AddItem "Surgical Equipment"
MType.AddItem "Capsule"
MType.AddItem "Harbal Product"
MType.AddItem "Topical Medicines"
MType.AddItem "Powder"
MType.AddItem "Antibiotics"
MType.AddItem "Inhalers"
MType.AddItem "Injection"
MType.AddItem "Antidepressants"
MType.AddItem "Anxiety Medications"
MType.AddItem "Antifungals"
MType.AddItem "Antiviral Drugs"
MType.AddItem "Antiparasitic Drugs"
MType.AddItem "Sleeping Pills"
MType.AddItem "Pain Killer"
MType.AddItem "Opioids"
MType.AddItem "Medications for Hypertension"
MType.AddItem "Medications for diabetes"
...
If Not Rs.EOF Then
    ...
    Frame1.Visible = True
    Frame1.Left = Admin.Width / 2 - Frame1.Width / 2
    Frame1.Top = Admin.Height / 2 - Frame1.Height / 2
...
DataList1.Top = 1400
DataList1.Left = 840 '2000
DataList1.Width = 3989
DataList1.Height = 7700 '9700
...
Private Sub cmdViewDelete_Click()
Call GridDelete_Click
End Sub
...
sort.AddItem "Type:Capsule Only"
sort.AddItem "Type:Liquid Only"
sort.AddItem "Type:Surgical Equipments Only"
sort.AddItem "Type:Injections Only"
sort.AddItem "Type:Topical Medicines Only"
sort.AddItem "Type:Opiods Only"
sort.AddItem "Type:Sleeping Pills Only"
sort.AddItem "Type:Antibiotics Only"
sort.AddItem "Type:Harbal Products Only"
sort.AddItem "Type:Antidepressants Only"
sort.AddItem "Type:Anxiety Medications Only"
sort.AddItem "Type:Antifungal Only"
sort.AddItem "Type:Antiviral Drugs Only"
sort.AddItem "Type:Antiparastic Drugs Only"
sort.AddItem "Type:Pain Killer Only"
sort.AddItem "Type:Medications for Hypertension Only"
sort.AddItem "Type:Medications for Diabetes"
...
ElseIf sort.Text = "Updated by Staff" Then
    DataGrid2.Visible = True
    DataGrid1.Visible = False
...
ElseIf sort.Text = "Type:Surgical Equipments Only" Then
    DataGrid2.Visible = True
    DataGrid1.Visible = False
    Adodc3.RecordSource = "select *from medicine where Type='Surgical Equipment'"
    Adodc3.Refresh
    lbl_no_of_records.Caption = Str(Adodc3.Recordset.RecordCount)
    
ElseIf sort.Text = "Type:Topical Medicines Only" Then
    DataGrid2.Visible = True
    DataGrid1.Visible = False
    Adodc3.RecordSource = "select *from medicine where Type='Topical Medicines'"
    Adodc3.Refresh
    lbl_no_of_records.Caption = Str(Adodc3.Recordset.RecordCount)
    
    
ElseIf sort.Text = "Type:Inhalers Only" Then
    DataGrid2.Visible = True
    DataGrid1.Visible = False
    Adodc3.RecordSource = "select *from medicine where Type='Inhalers'"
    Adodc3.Refresh
    lbl_no_of_records.Caption = Str(Adodc3.Recordset.RecordCount)

    
ElseIf sort.Text = "Type:Injections Only" Then
    DataGrid2.Visible = True
    DataGrid1.Visible = False
    Adodc3.RecordSource = "select *from medicine where Type='Injection'"
    Adodc3.Refresh
    lbl_no_of_records.Caption = Str(Adodc3.Recordset.RecordCount)
    
ElseIf sort.Text = "Type:Harbal Products Only" Then
    DataGrid2.Visible = True
    DataGrid1.Visible = False
    Adodc3.RecordSource = "select *from medicine where Type='Harbal Product'"
    Adodc3.Refresh
    lbl_no_of_records.Caption = Str(Adodc3.Recordset.RecordCount)

ElseIf sort.Text = "Type:Antibiotics Only" Then
    DataGrid2.Visible = True
    DataGrid1.Visible = False
    Adodc3.RecordSource = "select *from medicine where Type='Antibiotics'"
    Adodc3.Refresh
    lbl_no_of_records.Caption = Str(Adodc3.Recordset.RecordCount)
    
ElseIf sort.Text = "Type:Antidepressants Only" Then
    DataGrid2.Visible = True
    DataGrid1.Visible = False
    Adodc3.RecordSource = "select *from medicine where Type='Antidepressants'"
    Adodc3.Refresh
    lbl_no_of_records.Caption = Str(Adodc3.Recordset.RecordCount)

ElseIf sort.Text = "Type:Anxiety Medications Only" Then
    DataGrid2.Visible = True
    DataGrid1.Visible = False
    Adodc3.RecordSource = "select *from medicine where Type='Anxiety Medications'"
    Adodc3.Refresh
    lbl_no_of_records.Caption = Str(Adodc3.Recordset.RecordCount)

ElseIf sort.Text = "Type:Antifungals Only" Then
    DataGrid2.Visible = True
    DataGrid1.Visible = False
    Adodc3.RecordSource = "select *from medicine where Type='Antifungals'"
    Adodc3.Refresh
    lbl_no_of_records.Caption = Str(Adodc3.Recordset.RecordCount)


ElseIf sort.Text = "Type:Antiviral Drugs Only" Then
    DataGrid2.Visible = True
    DataGrid1.Visible = False
    Adodc3.RecordSource = "select *from medicine where Type='Antiviral Drugs'"
    Adodc3.Refresh
    lbl_no_of_records.Caption = Str(Adodc3.Recordset.RecordCount)
    
    
ElseIf sort.Text = "Type:Antiparasitic Drugs Only" Then
    DataGrid2.Visible = True
    DataGrid1.Visible = False
    Adodc3.RecordSource = "select *from medicine where Type='Antiparasitic Drugs'"
    Adodc3.Refresh
    lbl_no_of_records.Caption = Str(Adodc3.Recordset.RecordCount)
    
ElseIf sort.Text = "Type:Sleeping Pills Only" Then
    DataGrid2.Visible = True
    DataGrid1.Visible = False
    Adodc3.RecordSource = "select *from medicine where Type='Sleeping Pills'"
    Adodc3.Refresh
    lbl_no_of_records.Caption = Str(Adodc3.Recordset.RecordCount)
    
    
ElseIf sort.Text = "Type:Pain killer Only" Then
    DataGrid2.Visible = True
    DataGrid1.Visible = False
    Adodc3.RecordSource = "select *from medicine where Type='Pain Killer'"
    Adodc3.Refresh
    lbl_no_of_records.Caption = Str(Adodc3.Recordset.RecordCount)
    
    
ElseIf sort.Text = "Type:Opioids Only" Then
    DataGrid2.Visible = True
    DataGrid1.Visible = False
    Adodc3.RecordSource = "select *from medicine where Type='Opioidss'"
    Adodc3.Refresh
    lbl_no_of_records.Caption = Str(Adodc3.Recordset.RecordCount)
    
    
ElseIf sort.Text = "Type:Medications for Hypertension Only" Then
    DataGrid2.Visible = True
    DataGrid1.Visible = False
    Adodc3.RecordSource = "select *from medicine where Type='Medications for Hypertension'"
    Adodc3.Refresh
    lbl_no_of_records.Caption = Str(Adodc3.Recordset.RecordCount)
    

ElseIf sort.Text = "Type:Medications for diabetes Only" Then
    DataGrid2.Visible = True
    DataGrid1.Visible = False
    Adodc3.RecordSource = "select *from medicine where Type='Medications for diabetes'"
    Adodc3.Refresh
    lbl_no_of_records.Caption = Str(Adodc3.Recordset.RecordCount)
...
If KeyAscii = 13 Then
'Dim ch As Integer
'ch = txtqty(Val(txtQty1.Text))
If checkQty(Val(txtQty1.Text)) Then
    txtMedicine2.Visible = True
    txtMedicine2.SetFocus
    Shape7.Visible = True
    Price1.Caption = Val(P1.Caption) * Val(txtQty1.Text)
    Amount.Caption = Format(Val(Price1.Caption), "00.00")
    

Else
    MsgBox "The quantity must be between 1 and " & value.Text
    txtQty1.SelStart = 0
    txtQty1.SelLength = Len(txtQty1.Text)
 End If
End If
...
If KeyAscii = 13 Then
 If checkQty(Val(txtQty2.Text)) Then
    txtMedicine3.Visible = True
    txtMedicine3.SetFocus
    Shape8.Visible = True
    Price2.Caption = Val(P2.Caption) * Val(txtQty2.Text)
    Amount.Caption = Format(Amount.Caption + Val(Price2.Caption), "00.00")
 Else
    MsgBox "The quantity must be between 1 and " & value.Text
    txtQty2.SelStart = 0
    txtQty2.SelLength = Len(txtQty2.Text)
 End If
End If
End Sub
...
If KeyAscii = 13 Then
 If checkQty(Val(txtQty3.Text)) Then
    txtMedicine4.Visible = True
    txtMedicine4.SetFocus
    Shape9.Visible = True
    Price3.Caption = Val(P3.Caption) * Val(txtQty3.Text)
    Amount.Caption = Format(Amount.Caption + Val(Price3.Caption), "00.00")
 Else
    MsgBox "The quantity must be between 1 and " & value.Text
    txtQty3.SelStart = 0
    txtQty3.SelLength = Len(txtQty3.Text)
 End If
End If
End Sub
...
If KeyAscii = 13 Then
 If checkQty(Val(txtQty4.Text)) Then
    txtMedicine5.Visible = True
    txtMedicine5.SetFocus
    Shape10.Visible = True
    Price4.Caption = Val(P4.Caption) * Val(txtQty4.Text)
    Amount.Caption = Format(Amount.Caption + Val(Price4.Caption), "00.00")
Else
    MsgBox "The quantity must be between 1 and " & value.Text
    txtQty4.SelStart = 0
    txtQty4.SelLength = Len(txtQty4.Text)
 End If
End If
End Sub
...
If KeyAscii = 13 Then
 If checkQty(Val(txtQty5.Text)) Then
    txtMedicine6.Visible = True
    txtMedicine6.SetFocus
    Shape11.Visible = True
    Price5.Caption = Val(P5.Caption) * Val(txtQty5.Text)
    Amount.Caption = Format(Amount.Caption + Val(Price5.Caption), "00.00")
Else
    MsgBox "The quantity must be between 1 and " & value.Text
    txtQty5.SelStart = 0
    txtQty5.SelLength = Len(txtQty5.Text)
 End If
End If
End Sub
...
If KeyAscii = 13 Then
 If checkQty(Val(txtQty6.Text)) Then
    txtMedicine7.Visible = True
    txtMedicine7.SetFocus
    Shape12.Visible = True
    Price6.Caption = Val(P6.Caption) * Val(txtQty6.Text)
    Amount.Caption = Format(Amount.Caption + Val(Price6.Caption), "00.00")
 Else
    MsgBox "The quantity must be between 1 and " & value.Text
    txtQty6.SelStart = 0
    txtQty6.SelLength = Len(txtQty6.Text)
 End If
End If
End Sub
...
If KeyAscii = 13 Then
 If checkQty(Val(txtQty7.Text)) Then
    txtMedicine8.Visible = True
    txtMedicine8.SetFocus
    Shape13.Visible = True
    Price7.Caption = Val(P7.Caption) * Val(txtQty7.Text)
    Amount.Caption = Format(Amount.Caption + Val(Price7.Caption), "00.00")
 Else
    MsgBox "The quantity must be between 1 and " & value.Text
    txtQty7.SelStart = 0
    txtQty7.SelLength = Len(txtQty7.Text)
 End If
End If
End Sub
...
If KeyAscii = 13 Then
 If checkQty(Val(txtQty8.Text)) Then
    txtMedicine9.Visible = True
    txtMedicine9.SetFocus
    
    Price8.Caption = Val(P8.Caption) * Val(txtQty8.Text)
    Amount.Caption = Format(Amount.Caption + Val(Price8.Caption), "00.00")
 Else
    MsgBox "The quantity must be between 1 and " & value.Text
    txtQty8.SelStart = 0
    txtQty8.SelLength = Len(txtQty8.Text)
 End If
End If
End Sub
...
If KeyAscii = 13 Then
 If checkQty(Val(txtQty9.Text)) Then
    'txtMedicine9.Visible = True
    'txtMedicine9.SetFocus
    Billing_Print.SetFocus
    Price9.Caption = Val(P9.Caption) * Val(txtQty9.Text)
    Amount.Caption = Format(Amount.Caption + Val(Price9.Caption), "00.00")
 Else
    MsgBox "The quantity must be between 1 and " & value.Text
    txtQty9.SelStart = 0
    txtQty9.SelLength = Len(txtQty9.Text)
 End If
End If
End Sub

Function checkQty(ByVal q As Variant) As Integer

If Val(q) <= Val(value.Text) And q <> 0 Then
    checkQty = 1
Else
    checkQty = 0
End If
