...
If checkQty(Val(txtQty1.Text)) Then
    ...
    Shape7.Visible = True
    Price1.Caption = Val(Price1.Caption) * Val(txtQty1.Text)
...
If KeyAscii = 13 Then
 If checkQty(Val(txtQty2.Text)) Then
    ...
    Shape8.Visible = True
    Price2.Caption = Val(Price2.Caption) * Val(txtQty2.Text)
...
If KeyAscii = 13 Then
 If checkQty(Val(txtQty3.Text)) Then
    ...
    Shape9.Visible = True
    Price3.Caption = Val(Price3.Caption) * Val(txtQty3.Text)
...
If KeyAscii = 13 Then
 If checkQty(Val(txtQty4.Text)) Then
    ...
    Price4.Caption = Val(Price4.Caption) * Val(txtQty4.Text)
...
If KeyAscii = 13 Then
 If checkQty(Val(txtQty5.Text)) Then
    ...
    Price5.Caption = Val(Price5.Caption) * Val(txtQty5.Text)
...
If KeyAscii = 13 Then
 If checkQty(Val(txtQty6.Text)) Then
    ...
    Price6.Caption = Val(Price6.Caption) * Val(txtQty6.Text)
...
If KeyAscii = 13 Then
 If checkQty(Val(txtQty7.Text)) Then
    ...
    Price7.Caption = Val(Price7.Caption) * Val(txtQty7.Text)
...
If KeyAscii = 13 Then
 If checkQty(Val(txtQty8.Text)) Then
    ...
    Price8.Caption = Val(Price8.Caption) * Val(txtQty8.Text)
...
If KeyAscii = 13 Then
 If checkQty(Val(txtQty9.Text)) Then
    ...
    Price9.Caption = Val(Price9.Caption) * Val(txtQty9.Text)
